  ...
  return (
    <main className="px-10 flex justify-around items-center">
      ...
      <div className="flex flex-col gap-6">
        ...
        <p className="text-xl">
          An application which provides mental health support by leveraging the
          power of LLMs and community
        </p>
        <Link
          href="/Guide-Eval"
          ...
          onClick={() =>
            toast.success(
              "Get started by choosing a picture in the left side and then select a option on right side"
            )
          }
        >
